...
public class ViewProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Tạo đối tượng ProductDAO để gọi phương thức không tĩnh
        ProductDAO productDAO = new ProductDAO();

        // Gọi phương thức để lấy chi tiết sản phẩm từ ProductDAO
        Product product = productDAO.getProductById(productId);  // Lấy chi tiết sản phẩm

        // Gửi thông tin sản phẩm lên JSP
