                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="receiverName" name="receiverName" value="<%= order.getReceiverName() %>" disabled>
                            </div>

                            <!-- Receiver Address -->
                            <div class="mb-3">
                                <label for="receiverAddress" class="form-label">Receiver Address</label>
                                <input type="text" class="form-control" id="receiverAddress" name="receiverAddress" value="<%= order.getReceiverAddress() %>" disabled>
                            </div>

                            <!-- Receiver Phone -->
                            <div class="mb-3">
                                <label for="receiverPhone" class="form-label">Receiver Phone</label>
                                <input type="text" class="form-control" id="receiverPhone" name="receiverPhone" value="<%= order.getReceiverPhone() %>" disabled>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            $(".update-quantity").on("change", function () {
                ...
                let originalQuantity = parseInt($input.data("original-quantity"));
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            row.find(".subtotal").text(response.newSubtotal + " VND");
